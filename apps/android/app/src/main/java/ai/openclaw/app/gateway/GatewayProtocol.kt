...
enum class GatewayMethod(
  ...
  SkillsWriteValidate("skills.write.validate"),
  SkillsWritePropose("skills.write.propose"),
  SkillsWriteApplyProposal("skills.write.applyProposal"),
  SkillsWriteDirect("skills.write.direct"),
  SkillsWriteRefreshSnapshot("skills.write.refreshSnapshot"),
