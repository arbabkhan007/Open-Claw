...
const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "skills.write.validate", scope: "operator.read" },
  { name: "skills.write.propose", scope: "operator.admin" },
  { name: "skills.write.applyProposal", scope: "operator.admin" },
  { name: "skills.write.direct", scope: "operator.admin" },
  { name: "skills.write.refreshSnapshot", scope: "operator.admin" },
