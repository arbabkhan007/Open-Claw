// Loopback proof: dripping LINE content bodies cannot outlive the download deadline.
...
describe("LINE media download wall-clock loopback", () => {
  ...
  it("aborts a dripping content body within the wall-clock deadline", async () => {
    ...
    ).rejects.toThrow(/timed out after 0\.25 seconds/i);
