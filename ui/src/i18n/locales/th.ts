...
export const th: TranslationMap = {
  ...
  subtitles: {
    ...
    security: "การตรวจสอบสิทธิ์ Gateway, นโยบายการเรียกใช้, โปรไฟล์เครื่องมือ และการอนุมัติ",
    advanced: "ส่วนการตั้งค่าที่เหลือทั้งหมด พร้อมตัวแก้ไขไฟล์แบบ raw",
  ...
  custodian: {
    ...
    sensitivePlaceholder: "ป้อนค่าที่เป็นข้อมูลสำคัญ…",
